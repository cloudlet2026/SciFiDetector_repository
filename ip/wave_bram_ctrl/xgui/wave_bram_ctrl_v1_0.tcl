...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BRAM_DATA_DEPTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "BRAM_DATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "BRAM_STRB_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.BRAM_STRB_WIDTH { PARAM_VALUE.BRAM_STRB_WIDTH } {
	# Procedure called to update BRAM_STRB_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BRAM_STRB_WIDTH { PARAM_VALUE.BRAM_STRB_WIDTH } {
	# Procedure called to validate BRAM_STRB_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.BRAM_STRB_WIDTH { MODELPARAM_VALUE.BRAM_STRB_WIDTH PARAM_VALUE.BRAM_STRB_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BRAM_STRB_WIDTH}] ${MODELPARAM_VALUE.BRAM_STRB_WIDTH}
}
